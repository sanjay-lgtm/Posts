    ...
    return (
        <div className='my-10'>
            <div className='flex items-center justify-between text-sm'>
                ...
                <span className='font-medium cursor-pointer ml-5'>See All</span>
            </div>
            {
                suggestedUsers.map((user) => {
                    return (
                        <div key={ user._id } className='flex items-center justify-between my-5'>
                            ...
                            <span className='text-[#3BADF8] text-xs font-bold cursor-pointer hover:text-[#3495d6] ml-5'>Follow</span>
                        </div>
                    )
                })
            }
