...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('https://posts-0qau.onrender.com/api/v1/user/profile/edit', formData, {
                headers: {
            ...
            if (res.data.success) {
                ...
                setPreviewImage(null); // Reset the preview image after successful upload
            ...
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div className='flex items-center justify-between bg-gray-100 rounded-xl p-4'>
                    <div className='flex items-center gap-3'>
                        <Avatar>
                            <AvatarImage src={ previewImage || user?.profilePicture } alt="profile_image" />
